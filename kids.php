...
<head>
    ...
    <title>Çocuk Ürünleri - Stilistre</title>
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="stylesheet" href="Style/kids.css"> <style>
        /* CSS for the profile dropdown (can be moved to kids.css) */
        /* Eğer profile dropdown için özel CSS'iniz varsa buraya veya kids.css'e ekleyin */
        ...
        <nav>
            <div class="container">
                <ul>
                    ...
                    <li><a href="male.php">Erkek</a></li> <li><a href="kids.php" class="active">Çocuk</a></li>
        ...
        <div class="container">
            ...
            <div class="products-grid">
                ...
                <div class="product-card">
                    <div class="product-img">
                        <img src="https://images.unsplash.com/photo-1596752702755-d41c1fb3a23a?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80"
                            alt="Çocuk Kot Pantolon">
                        <span class="product-badge">%20 İndirim</span>
                        <div class="quick-view">Hızlı Görünüm</div>
                    </div>
                    <div class="product-info">
                        <h3>Çocuk Kot Pantolon</h3>
                        <div class="price">
                            <div class="current">₺149.99</div>
                            <div class="old">₺189.99</div>
                        </div>
                        <button class="add-to-cart">Sepete Ekle</button>
                    </div>
                </div>
                ...
                <div class="product-card">
                    <div class="product-img">
                        <img src="https://images.unsplash.com/photo-1542291026-78cc75701539?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80"
                            alt="Çocuk Spor Ayakkabı">
                        <span class="product-badge">Popüler</span>
                        <div class="quick-view">Hızlı Görünüm</div>
                    </div>
                    <div class="product-info">
                        <h3>Renkli Çocuk Spor Ayakkabı</h3>
                        <div class="price">
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <h3>Çiçekli Kız Çocuk Elbisesi</h3>
                        <div class="price">
                ...
                <div class="product-card">
                    <div class="product-img">
                        <img src="https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80"
                            alt="Çocuk Sweatshirt">
                        <span class="product-badge">Yeni</span>
                        <div class="quick-view">Hızlı Görünüm</div>
                    </div>
                    <div class="product-info">
                        <h3>Kapüşonlu Çocuk Sweatshirt</h3>
                        <div class="price">
                            <div class="current">₺179.99</div>
                            <div class="old">₺229.99</div>
                        </div>
                        <button class="add-to-cart">Sepete Ekle</button>
                    </div>
                </div>
                ...
                <div class="product-card">
                    <div class="product-img">
                        <img src="https://images.unsplash.com/photo-1617137968427-85924c800a22?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80"
                            alt="Çocuk Pijama Takımı">
                        <span class="product-badge">Set</span>
                        <div class="quick-view">Hızlı Görünüm</div>
                    </div>
                    <div class="product-info">
                        <h3>Desenli Çocuk Pijama Takımı</h3>
                        <div class="price">
                            <div class="current">₺249.99</div>
                            <div class="old">₺329.99</div>
                        </div>
                        <button class="add-to-cart">Sepete Ekle</button>
                    </div>
                </div>
